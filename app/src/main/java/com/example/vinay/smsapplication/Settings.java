package com.example.vinay.smsapplication;
...
import com.example.vinay.smsapplication.Backup_Restore.DownloadFromDrive;
import com.example.vinay.smsapplication.Backup_Restore.LocalExport;
import com.example.vinay.smsapplication.Backup_Restore.NetworkStatus;
import com.example.vinay.smsapplication.Backup_Restore.UploadToDrive;
...
import static com.example.vinay.smsapplication.Constants.Network_Constants.CONNECTED_VIA_CELLULAR;
import static com.example.vinay.smsapplication.Constants.Network_Constants.CONNECTED_VIA_WIFI;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        backupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d(TAG,"connect"+ canConnect());
                if (!mGoogleApiClient.isConnected() && canConnect()) {
    ...
    protected void onActivityResult(final int requestCode, final int resultCode, final Intent data) {
        switch (requestCode) {
            case RESOLVE_CONNECTION_REQUEST_CODE:
                Log.d(TAG,"Activityresult"+resultCode);
